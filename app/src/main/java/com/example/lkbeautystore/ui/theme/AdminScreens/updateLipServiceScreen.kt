        ...
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    placeholder = { Text("e.g., Lip Blushing") },
                    ...
                    Button(
                        onClick = {
                            ...
                            productViewmodel.updateLipService(
                                ...
                                onSuccess = {
                                    isUpdating = false
                                    Toast.makeText(context, "Lip service updated successfully", Toast.LENGTH_SHORT).show()
